# EXERCÍCIO: Cadastro e Gerenciamento de Estudantes
# Objetivo: O programa permite realizar diversas operações com um cadastro de estudantes:
# 1. Adicionar um novo estudante com nome, idade e notas.
# 2. Remover um estudante já cadastrado.
# 3. Atualizar as notas de um estudante.
# 4. Exibir as informações de um estudante (nome, idade e notas).
# 5. Calcular e exibir a média das notas de um estudante.
# 
# O programa oferece um menu interativo para o usuário escolher qual operação deseja realizar.
